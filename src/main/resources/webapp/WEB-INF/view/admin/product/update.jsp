                        ...
                        <div class="row">
                            <div class="col-lg-10 col-12 mx-auto">
                                ...
                                <form:form action="/admin/product/update" method="post" modelAttribute="newProduct"
                                    ...
                                    <form:input type="hidden" path="sold" />
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            <label for="productFile" class="form-label">Product Image (optional)</label>
                                        ...
                                        <div class="col-md-6 d-flex align-items-end">
                                            <c:choose>
                                                <c:when test="${not empty newProduct.image}">
                                                    <img style="max-height: 140px;" alt="product preview"
                                                        id="productPreview"
                                                        src="/resources/images/product/${newProduct.image}" />
                                                </c:when>
                                                <c:otherwise>
