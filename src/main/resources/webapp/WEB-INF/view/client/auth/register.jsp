                    ...
                    <div class="auth-card">
                        <div class="text-center">
                            <div class="auth-switch">
                                <a class="auth-switch__item is-active" href="/register" aria-current="page">Đăng ký</a>
                                <a class="auth-switch__item" href="/login">Đăng nhập</a>
                            </div>
                            <h2 class="fw-bold mb-2">Tạo tài khoản LaptopShop</h2>
                            <p class="auth-subtitle mb-0">Đăng ký nhanh để bắt đầu mua sắm và nhận ưu đãi.</p>
                        </div>
                        ...
                        <form:form action="/register" method="post" modelAttribute="registerUser" class="mt-4">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <form:input type="text" path="firstName" cssClass="form-control"
                                        cssErrorClass="form-control is-invalid" placeholder="Ví dụ: Nguyễn"
                                        required="true" maxlength="50" autocomplete="family-name" />
                                ...
                                <div class="col-md-6">
                                    ...
                                    <form:input type="text" path="lastName" cssClass="form-control"
                                        cssErrorClass="form-control is-invalid" placeholder="Ví dụ: An" required="true"
                                ...
                                <div class="col-12">
                                    ...
                                    <form:input type="email" path="email" cssClass="form-control"
                                        cssErrorClass="form-control is-invalid" placeholder="you@example.com"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <form:input type="password" path="password" cssClass="form-control"
                                        cssErrorClass="form-control is-invalid" placeholder="Tối thiểu 8 ký tự"
                                        required="true" minlength="8" maxlength="64" autocomplete="new-password" />
                                ...
                                <div class="col-md-6">
                                    ...
                                    <form:input type="password" path="confirmPassword" cssClass="form-control"
                                        cssErrorClass="form-control is-invalid" placeholder="Nhập lại mật khẩu"
                                        required="true" minlength="8" maxlength="64" autocomplete="new-password" />
                            ...
                            <div
                                ...
                                <button type="submit" class="btn btn-auth px-5">Tạo tài khoản</button>
                            </div>
                        </form:form>
                    </div>
                </div>
