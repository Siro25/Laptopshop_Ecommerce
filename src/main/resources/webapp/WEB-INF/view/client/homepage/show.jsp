                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8 text-white">
                            <h4 class="mb-3 text-warning border-bottom border-warning d-inline-block pb-2">Khám phá
                                laptop
                                phù hợp với bạn</h4>
                            <h1 class="display-3 fw-bold mb-4 text-white">🔥 Giảm giá đến 30% Laptop Gaming</h1>
                            <p class="fs-5 mb-5 text-light">Sở hữu sức mạnh vô song với mức giá không tưởng. Cơ hội có
                                1-0-2
                                trong năm.</p>
            ...
            <div class="container-fluid py-5" id="products">
                <div class="container py-5">
                    <div class="d-flex justify-content-between align-items-end mb-5">
                        <div>
                            <h1 class="display-5 fw-bold" style="font-family: var(--font-heading);">Sản Phẩm Nổi Bật
                            </h1>
                            <p class="text-muted">Danh sách các sản phẩm đang được ưa chuộng nhất tại hệ thống
                                LaptopShop.
                            </p>
                        </div>
                        ...
                        <c:forEach var="product" items="${products}">
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="product-card h-100 d-flex flex-column position-relative">
                                    <span class="badge-category">${product.factory}</span>
